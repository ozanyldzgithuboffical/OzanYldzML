...
About the Code:
   ...
   -Sometimes data variable types or data itself with its max and min values
    can be hard to be evaluated.To fit different fields to each other we can 
    use induction method such as standardization
...
dependentTrain,dependentTest,independentTrain,independentTest=train_test_split(ultimateDataFrame,genderDataFrame,test_size=0.33,random_state=0)
