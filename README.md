...
- A **linear function** has one independent variable and one dependent variable. The independent variable is x and the dependent variable is y. y=ax+b+e
...
- **e** is the error from the deviation of the line in two dimentional hyperplane.
